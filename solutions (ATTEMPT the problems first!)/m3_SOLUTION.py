...
def get_second_largest(m, sequence):
    ...
    largest = None
    second_largest = None
    for k in range(len(sequence) - m, len(sequence)):
        number = sequence[k]
    ...
    # Alternate solution that MUTATES the list by:
    #  - Find the largest number.
    #  - "Wipe out" that largest number in the list.
    #  - Find the largest number in the "wiped out" list.
    #  - Return that number.
    # largest = None
    # index_of_largest = None
    # for k in range(len(sequence) - m, len(sequence)):
    #     number = sequence[k]
    #     if largest is None or number > largest:
    #         largest = number
    #         index_of_largest = k
    #
    # sequence[index_of_largest] = None  # Set it to an impossible value
    #
    # second_largest = None
    # for k in range(len(sequence) - m, len(sequence)):
    #     number = sequence[k]
